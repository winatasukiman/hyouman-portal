...
class ProjectProject(models.Model):
    ...
    def action_notify(self, success):
        ...
        notification = {
            ...
            'params': {
                'title': _('Successful') if success is True else _(
                    'Warning'),
                'message': 'Asana data successfully imported.' if success is True else 'Import not successful!',
                'sticky': True,
    ...
    def action_import_asana_data(self):
        ...
        for record in self:
            ...
            try:
                ...
                return record.action_notify(True)
                ...
                if not task_record:
                    ...
                    for subtask in subtask_response:
                        ...
                        if not subtask_record:
                            subtask_record = self.env['project.task'].create(subtask_record)
